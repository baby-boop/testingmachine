...
public class productTreasurer {
    ...
    public void data(){
        try{
            ...
            e.printStackTrace();
            System.out.println("Error class-productTreasurer : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished productTreasurer");
        }
    }
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = (processName+"class-productTreasurer: "+ this.getClass().getName() + "   processName= " + "   Алдаа: " + errorText);
