...
public class notTimeRegistration {
    ...
    public void time() {
        try {
            ...
            e.printStackTrace();
            System.out.println("Error class-notTimeRegistration : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished notTimeRegistration");
        }
    ...
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-notTimeRegistration: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
