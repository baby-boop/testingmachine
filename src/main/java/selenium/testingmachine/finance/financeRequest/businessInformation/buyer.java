...
public class buyer {
    ...
    public void business(){
        try{
            ...
            e.printStackTrace();
            System.out.println("Error class-buyer : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished buyer");
        }
    }
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-buyer: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
