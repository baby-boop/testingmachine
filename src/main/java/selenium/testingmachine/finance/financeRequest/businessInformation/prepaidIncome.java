...
public class prepaidIncome {

    public static String message;

    private WebDriver driver;

    public prepaidIncome(WebDriver driver) {
        this.driver = driver;
    }
    public void finance(){
        try{
            ...
            WebElement subMain = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(.,'Урьдчилж орсон орлого')]")));
            subMain.click();
