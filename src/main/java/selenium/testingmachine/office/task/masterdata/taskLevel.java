package selenium.testingmachine.office.task.masterdata;
...
public class taskLevel {
   public static String message;
    ...
    public taskLevel(WebDriver driver) {
        this.driver = driver;
    }
    public void data(){
        try{
            ...
            WebElement name = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input[data-path='PRIORITY_ORDER']")));
            name.sendKeys("5");
            ...
            e.printStackTrace();
            System.out.println("Error class-taskLevel : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished taskLevel");
        }
    }
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-taskLevel: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
