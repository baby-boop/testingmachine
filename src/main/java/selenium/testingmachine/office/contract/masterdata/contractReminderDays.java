...
public class contractReminderDays {
    public static String message;

    private WebDriver driver;

    public contractReminderDays(WebDriver driver) {
        this.driver = driver;
    }
    public void data(){
        try{
            ...
            e.printStackTrace();
            System.out.println("Error class-contractReminderDays : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished contractReminderDays");
        }
    }
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-contractReminderDays: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
