...
public class contractReasonsForTermination {
    public static String message;

    private WebDriver driver;

    public contractReasonsForTermination(WebDriver driver) {
        this.driver = driver;
    }
    public void data(){
        try{
            ...
            e.printStackTrace();
            System.out.println("Error class-contractReasonsForTermination : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished contractReasonsForTermination");
        }
    }
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-contractReasonsForTermination: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
