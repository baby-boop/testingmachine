...
public class contractPaymentType {
    ...
    public void data(){
        try{
            ...
            e.printStackTrace();
            System.out.println("Error class-contractPaymentType : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished contractPaymentType");
        }
    }
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-contractPaymentType: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
