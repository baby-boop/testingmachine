...
public class contractType {
    ...
    public void data(){
        try{
            ...
            e.printStackTrace();
            System.out.println("Error class-contractType : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished contractType");
        }
    }
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-contractType: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
