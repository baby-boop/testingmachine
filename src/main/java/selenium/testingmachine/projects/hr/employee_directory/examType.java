...
public class examType {
    ...
    public examType(WebDriver driver) {
        this.driver = driver;
    }
    public void types(){
        try{
            ...
            WebElement menu = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a[data-stepid='16741120567124']"))); //Шалгалтын төрөл
            menu.click(); 
            ...
            WebElement type = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("mvParam[EXAM_TYPE_NAME]")));
            type.sendKeys("test2");
