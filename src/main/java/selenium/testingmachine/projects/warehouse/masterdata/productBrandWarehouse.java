...
public class productBrandWarehouse {

    private WebDriver driver;

    public productBrandWarehouse(WebDriver driver) {
        this.driver = driver;
    }
    public void data(){
        try{
            ...
            WebElement menu = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[data-stepid='17083323427699']")));
            menu.click(); 
