...
public class locationWarehouse {
    ...
    public locationWarehouse(WebDriver driver) {
        this.driver = driver;
    }
    public void data(){
        try{
            ...
            WebElement locationNextSaveBtn2 = wait.until(ExpectedConditions.elementToBeClickable(locationNextDiv.findElement(By.xpath(".//button[contains(text(), 'Хадгалах')]"))));          
            locationNextSaveBtn2.click();
