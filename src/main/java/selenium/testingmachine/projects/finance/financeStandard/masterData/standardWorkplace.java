...
public class standardWorkplace {

    private WebDriver driver;

    public standardWorkplace(WebDriver driver) {
        this.driver = driver;
    }
    public void data(){
        try{
            ...
            WebElement menu = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[data-stepid='16842267718549']")));
            menu.click(); 
            ...
            WebElement positionField = wait.until(ExpectedConditions.elementToBeClickable(By.name("positionId_nameField")));
            positionField.sendKeys("test");
            positionField.sendKeys(Keys.ENTER);

            Thread.sleep(1000);

            WebElement directionField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div[data-s-path='directionId']")));
            directionField.click();
            WebElement directionOption = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='select2-result-label' and text()='Цалин хариуцсан']")));
            ...
            WebElement vacancyCount = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input[data-path='vacancyCount']")));
            vacancyCount.sendKeys("1");

            WebElement conditionField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div[data-s-path='conditionId']")));
            conditionField.click();
            WebElement conditionOption = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='select2-result-label' and text()='Хэвийн']")));
