...
public class standardBank {
    ...
    public standardBank(WebDriver driver) {
        this.driver = driver;
    }
    public void data(){
        try{
            ...
            WebElement menu = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[data-stepid='16643582971509']")));
            menu.click(); 
            ...
            WebElement codeField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("mvParam[BANK_CODE]")));
            codeField.sendKeys("1");

            WebElement nameField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("mvParam[BANK_NAME]")));
