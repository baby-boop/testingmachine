...
public class unitType {
    ...
    public void unit(){
        try{
            ...
            Thread.sleep(1000);
            WebElement link = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(.,'Нэгжийн төрөл')]")));
            link.click();
            ...
            WebElement order = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("mvParam[ORDER_NUMBER]")));
            order.sendKeys("7");
            ...
            e.printStackTrace();
            System.out.println("Error class-unitType : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished unitType");
        }
    }
    ...
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-unitType: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
