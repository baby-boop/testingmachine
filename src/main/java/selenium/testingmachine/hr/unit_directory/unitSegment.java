...
public class unitSegment {
    ...
    public void unit(){
        try{
            ...
            Thread.sleep(2000);
            WebElement link = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(.,'Нэгжийн сегмент')]")));
            link.click();
            ...
            e.printStackTrace();
            System.out.println("Error class-unitSegment : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished unitSegment");
        }
    }
    ...
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-unitSegment: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
