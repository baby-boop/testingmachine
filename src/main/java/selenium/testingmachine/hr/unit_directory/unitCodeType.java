...
public class unitCodeType {
    ...
    public void unit(){
        try{
            ...
            Thread.sleep(1000);
            WebElement link = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(.,'Нэгжийн ангилал')]")));
            link.click();
            ...
            e.printStackTrace();
            System.out.println("Error class-unitCodeType : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished unitCodeType");
        }
    }
    ...
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-unitCodeType: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
