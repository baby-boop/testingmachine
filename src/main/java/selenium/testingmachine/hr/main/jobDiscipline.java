...
public class jobDiscipline {
    ...
    public void warning(){
        try{
            ...
            WebElement benefits = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(.,'Сахилга')]")));
            benefits.click();
            ...
            //hide hiisn param awah
            wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("input[name='param[HCM_LABOUR_BOOK_DTL.startDate][0][]']")));
            JavascriptExecutor js = (JavascriptExecutor) driver;
            js.executeScript("document.querySelector('input[name=\"param[HCM_LABOUR_BOOK_DTL.startDate][0][]\"]').value='2024-06-07';");
            ...
            WebElement employeeStatus = wait.until(ExpectedConditions.elementToBeClickable(By.id("s2id_param[HCM_LABOUR_BOOK_DTL.punishmentTypeId][0][]")));
            ...
            e.printStackTrace();
            System.out.println("Error class-jobDiscipline : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished jobDiscipline");
        }
    }
}
