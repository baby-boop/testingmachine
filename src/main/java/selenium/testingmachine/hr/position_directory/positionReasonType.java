...
public class positionReasonType {
    public static String message;

    private WebDriver driver;

    public positionReasonType(WebDriver driver) {
        this.driver = driver;
    }
    public void position(){
        try{
            ...
            Thread.sleep(1500);
            WebElement link = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(.,'Албан тушаалын ангилал')]")));
            link.click();
            ...
            WebElement name = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("mvParam[CLASSIFICATION_NAME]")));
            ...
            e.printStackTrace();
            System.out.println("Error class-positionReasonType : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished positionReasonType");
        }
    }
    ...
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-positionReasonType: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
