...
public class salaryTypeForPosition {
    public static String message;

    private WebDriver driver;

    public salaryTypeForPosition(WebDriver driver) {
        this.driver = driver;
    }
    public void position(){
        try{
            ...
            Thread.sleep(2000);
            WebElement link = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(.,'Цалинжих төрөл')]")));
            link.click();
            ...
            e.printStackTrace();
            System.out.println("Error class-salaryTypeForPosition : " + e.getMessage());
            driver.quit();
        }finally{
            System.out.println("finished salaryTypeForPosition");
        }
    }
    ...
    private boolean isErrorMessagePresent(WebDriverWait wait) {
        try {
            ...
            message = ("class-salaryTypeForPosition: "+ this.getClass().getName() + "   processName= "+processName + "   Алдаа: " + errorText);
